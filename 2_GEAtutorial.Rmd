...
Genotypes <- read.table("./Pine_AllNatural_GCandTotemIndivs_GWAS_SNPs_June8th2019.txt", header = T)
```
...
InfoInd <- read.table("./Pine_TotemField_AllNaturalIndivResiduals_Jan20th2017.csv", sep = ",", header = T)
...
# Set working directory
setwd("/Users/magenamarzonie/Library/CloudStorage/OneDrive-JamesCookUniversity/R Scripts/Ch3_Dartseq/AcroporaDartseq")
